...
def get_translation_table() -> bytes:
    # braille_table = {}
    # for b in range(256):
    #     reordered = reorder_bits(b, reversed((0, 3, 1, 4, 2, 5, 6, 7)))
    #     print(f"{b:08b} {reordered:08b}  {chr(b + 0x2800)}  {chr(reordered + 0x2800)}")
    #     braille_table[reordered] = b
...
#
#     return chr(binary.to_bytes(1, "little").translate(braille_table) | 0x2800)
#
#
